...
const Services = () => {
  ...
  const [activeTab, setActiveTab] = useState(searchParams.get('tab') || 'birthday');
        ...
        <div className="container mx-auto px-4">
          <div className="flex space-x-4">
            <button
              ...
              className={`py-4 px-6 text-lg font-semibold border-b-2 transition-colors duration-300 ${activeTab === 'birthday'
            ...
            <button
              ...
              className={`py-4 px-6 text-lg font-semibold border-b-2 transition-colors duration-300 ${activeTab === 'wedding'
                ? 'border-primary text-primary'
                : 'border-transparent text-gray-600 hover:text-primary'
                }`}
            >
            ...
            <button
              ...
              className={`py-4 px-6 text-lg font-semibold border-b-2 transition-colors duration-300 ${activeTab === 'corporate'
                ? 'border-primary text-primary'
                : 'border-transparent text-gray-600 hover:text-primary'
                }`}
            >
            ...
            {(activeTab === 'birthday' ? birthdayServices : activeTab === 'wedding' ? weddingServices : corporateServices).map((service, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                ...
                <button
                  ...
                  className="mt-4 w-full bg-primary text-white py-2 px-4 rounded-lg hover:bg-primary-dark transition-colors duration-300"
                >
                  View Details
                </button>
              </div>
